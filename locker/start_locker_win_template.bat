...
IF DEFINED PRIVKEY_LOC SET ESC_PRIVKEY_LOC=%PRIVKEY_LOC:\=/%
IF DEFINED ESC_PRIVKEY_LOC CALL SET ESC_PRIVKEY_LOC=%%ESC_PRIVKEY_LOC:%ROOT%=%%
IF DEFINED PUBKEY_LOC SET ESC_PUBKEY_LOC=%PUBKEY_LOC:\=/%
IF DEFINED ESC_PUBKEY_LOC CALL SET ESC_PUBKEY_LOC=%%ESC_PUBKEY_LOC:%ROOT%=%%
IF DEFINED AWSCREDS_LOC SET ESC_AWSCREDS_LOC=%AWSCREDS_LOC:\=/%
IF DEFINED ESC_AWSCREDS_LOC SET ESC_AWSCREDS_LOC=%%ESC_AWSCREDS_LOC:%ROOT%=%%
